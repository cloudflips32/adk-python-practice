...
root_agent = Agent(
    ...
    instruction='Help the user better learn how to use Windows Powershell and the Linux Bash terminal by digesting user queries and providing the correct command for their needs. Be sure to verify the correct terminal, as well as the correct command for the given task.',
